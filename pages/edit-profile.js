...
class EditProfile extends React.Component {
  ...
  showError = err => {
    ...
    this.setState({ error, openError: true, isLoading: false, isSaving: false });
  }

  render() {
      const { classes } = this.props;
    const { name, email, avatar, about, isLoading, isSaving, avatarPreview, updatedUser, openSuccess, openError, error } = this.state;
    ...
    return (
        ...
        <input name="avatar" type="file" id="avatar" accept="image/*" onChange={this.handleChange} className={classes.input} />
      ...
      name="name"
      value={name}
      onChange={this.handleChange}></Input></FormControl>
