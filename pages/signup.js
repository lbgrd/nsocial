  ...
  render() {
    ...
    const { error, openError, openSuccess, createdUser, isLoading } = this.state;
        return (
            ...
            <Button type="submit" fullWidth variant="contained" color="primary" disabled={isLoading} className={classes.submit}>{isLoading ? "Signing up" : "Sign up"}</Button>
            </form>
            {/* Error snackbar */}
      ...
      TransitionComponent={Transition}>
        ...
        <Link href="/signin">
        <a className={classes.signinLink}>Sign in</a></Link></Button></DialogActions>
        </Dialog>
      </div>);
  }
}
