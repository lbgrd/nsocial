...
class PostFeed extends React.Component {
  ...
  getPosts = () => {
    ...
    getPostFeed(auth.user._id).then(posts => this.setState({ posts : posts}));
  }
  ...
  render() {
    ...
    return (
        ...
        {posts.map(post => (<Post key={post._id} auth={auth} post={post} isDeletingPost={this.isDeletingPost} handleDeletePost={this.handleDeletePost} handleToggleLike={this.handleToggleLike} handleAddComment={this.handleAddComment} handleDeleteComment={this.handleDeleteComment}/>))}
      </div>)
  }
}
