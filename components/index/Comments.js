...
class Comments extends React.Component {
  ...
  showComment = comment => {
    ...
    return (
      ...
      {isCommentCreator && (
          <Delete color="secondary" onClick={() => handleDeleteComment(postId, comment)} className={classes.commentDelete}/>
      )}
      </span>
        </div>
    )
  ...
  render() {
    ...
    return (
        ...
        {/* Comment Input */}
        <CardHeader
      avatar={<Avatar className={classes.smallAvatar} src={auth.user.avatar} />} title={<form onSubmit={this.handleSubmit}>
                                                                                        ...
                                                                                        onChange={this.handleChange}/>                                                                                </FormControl>                                                                                </form>
                                                                                       }
